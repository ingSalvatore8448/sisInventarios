...
@section('contenido')
    ...
    {!! Form::open(array('url'=>'MobiResponsable','method'=>'POST','autocomplete'=>'off','files'=>true)) !!}
    {{Form::token()}}
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="cantidad" required="Campo Obligatorio" name="cantidad"  placeholder="cantidad">
            </div>
