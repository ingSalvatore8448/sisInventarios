...
class MobiController extends Controller
{
    ...
    public function index(Request $request){
        if($request){
            ...
            return view('MobiResponsable.listarMobiliario',['mobiliarios'=>$mobiliarios,'searchText'=>$query]);
    ...
    public function create(){
        ...
        return view('MobiResponsable.createMobi',['departamento'=>$departamento,'categoria'=>$categoria]);
    }
    public function store(Mobiliariorequest $request){
        ...
        return view('MobiResponsable.listarMobiliario');
    }
    ...
    public function update(Mobiliariorequest $request,$id){
        ...
        return view('Mobiliarios.indexMobi');
